...
public class Main {
    public static void main(String[] args) {
        ...
        //Usar a API para ordenar e mostrar a ordem dos ataques mais fortes da batalha
        Collections.sort(registroAtaques, Comparator.comparingDouble(Ataque::getDano).reversed());

        System.out.println("\nResumo dos ataques mais fortes:");
        for (int i = 0; i < Math.min(5, registroAtaques.size()); i++) {
            System.out.println(registroAtaques.get(i));
        }
    }
